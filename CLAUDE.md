...
│   ├── run-tests.sh                 # Test runner (119 unit/integration files); exit 2 = nothing checked
...
```bash
tests/run-tests.sh                    # Run all unit/integration tests (119 files)
