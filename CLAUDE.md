...
│   ├── run-tests.sh                 # Test runner (109 unit/integration files); exit 2 = nothing checked
...
```bash
tests/run-tests.sh                    # Run all unit/integration tests (109 files)
