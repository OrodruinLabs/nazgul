...
assert_json_field "v1 config → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
assert_json_field "v2 config → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
assert_json_field "v3 config → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
assert_json_field "v4 config → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
assert_json_field "v5 config → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
assert_json_field "v6 config → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
assert_json_field "v7 → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
assert_json_field "v8 → v10 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "10"
...
# --- Test 3j: v10 config → no-op ---
NAZGUL_DIR=$(setup_nazgul_dir "v10-config")
cat > "$NAZGUL_DIR/config.json" << 'EOF'
{ "schema_version": 10, "mode": "hitl" }
EOF
OUTPUT=$(CLAUDE_PLUGIN_ROOT="$REPO_ROOT" "$MIGRATE" "$NAZGUL_DIR" 2>/dev/null) || true
assert_eq "v10 config → no output" "$OUTPUT" ""
...
EOF
OUTPUT=$(CLAUDE_PLUGIN_ROOT="$REPO_ROOT" "$MIGRATE" "$NAZGUL_DIR" 2>/dev/null) || true
assert_json_field "v9 → v10 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "10"
