...
assert_json_field "v1 config → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v2 config → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v3 config → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v4 config → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v5 config → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v6 config → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v7 → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v8 → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v12 → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v13 → v21 (full chain) schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
EOF
OUTPUT=$(CLAUDE_PLUGIN_ROOT="$REPO_ROOT" "$MIGRATE" "$NAZGUL_DIR" 2>/dev/null) || true
assert_json_field "v14 → v21 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v16 → v21 schema_version (via v17)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
EOF
OUTPUT=$(CLAUDE_PLUGIN_ROOT="$REPO_ROOT" "$MIGRATE" "$NAZGUL_DIR" 2>/dev/null) || true
assert_json_field "v9 → v21 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
EOF
OUTPUT=$(CLAUDE_PLUGIN_ROOT="$REPO_ROOT" "$MIGRATE" "$NAZGUL_DIR" 2>/dev/null) || true
assert_json_field "v10 → v21 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
EOF
OUTPUT=$(CLAUDE_PLUGIN_ROOT="$REPO_ROOT" "$MIGRATE" "$NAZGUL_DIR" 2>/dev/null) || true
assert_json_field "v11 → v21 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "unversioned modern → reaches v21" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v15 → v21 schema_version (full chain)" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v17 → v21 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v18 → v21 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v20 → v21 schema_version" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v1→v21 chain reaches schema_version 21" "$NAZGUL_DIR/config.json" ".schema_version" "22"
...
assert_json_field "v19 → v21 schema_version (walks to terminal)" "$TMPDIR_V20/nazgul/config.json" ".schema_version" "22"
