...
You build and maintain the deployment pipeline. Read `<main_worktree_path>/nazgul/config.json → project.infrastructure.cicd_platform` for the selected platform.
