...
3. **Never** offer FRESH, OBJECTIVE_COMPLETE, or a New Objective Override from this state, and never archive anything. An operator who genuinely wants a clean slate has `/nazgul:reset`, which is an explicit, informed choice; this is not.
**Stop here.**
