...
- **Survives interruptions** — checkpoints, recovery pointers, session tracking, and hooks mean you can close your laptop and resume later; the loop also holds an allowed, uncounted stop while dispatched work is still running instead of burning iterations on it
